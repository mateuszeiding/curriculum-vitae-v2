...
export const getExperience: ExperienceModel[] = [
  ...
  },
  {
    ...
    description:
      'Design system created for the entire department to ensure consistency and reusability across projects.',
    bulletPoints: [
      {
        value: 'Implementing design system in style framework',
      },
      {
        value: 'Helping with migration to new design system',
      },
    ],
  },
  {
    ...
    techStack: ['Vue', '.NET'],
    description:
      'System for managing users, roles, permissions, and organizational structure, integrated with a legacy application.',
    bulletPoints: [],
  },
  {
    ...
    description:
      'Module supporting employee cooperation through group assignments, task management, status updates and comments.',
    bulletPoints: [],
  },
  {
    project: 'open API',
    techStack: ['.NET'],
    description:
      'An integration API that enables customers to use modules and applications provided by multiple third-party vendors.',
    bulletPoints: [],
  },
]
